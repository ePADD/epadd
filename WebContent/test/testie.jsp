...
if(p.equals("expandname")){
	...
	if(allEntities == null){
		...
		for(String docId: docMap.keySet()){
			...
			List<String> persons = archive.getEntityBookManager().getEntitiesInDoc(ed, etype);
			List<String> orgs = archive.getEntityBookManager().getEntitiesInDoc(ed, otype);
			List<String> places = archive.getEntityBookManager().getEntitiesInDoc(ed, ptype);
