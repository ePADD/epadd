...
<%
    ...
    for (EmailDocument ed: docs) {
        ...
        Span[] es = archive.getAllNamesMapToInDoc(ed, true, ct);
        for(Span name: es){
            double s = name.typeScore;
            if (s < cutoff)
                continue;
            entities.add(name.text);
        }
...
// 		List<String> scores = indexer.getNamesInDoc(ed, type+edu.stanford.muse.ie.ie.NER.SCORE_SUFFIX);
...
// 	}
        ...
        entities = edu.stanford.muse.ie.Util.filterEntities(entities, ct);
